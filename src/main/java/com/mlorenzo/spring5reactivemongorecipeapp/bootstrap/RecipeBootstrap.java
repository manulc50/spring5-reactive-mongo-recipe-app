...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryReactiveRepository categoryReactiveRepository,
    ...
    private List<Recipe> getRecipes() {
        ...
        Mono<UnitOfMeasure> cupsUomMono = unitOfMeasureReactiveRepository.findByDescription("Cup")
        		.switchIfEmpty(Mono.error(new RuntimeException("Expected UOM Not Found")));
        //get UOMs
        UnitOfMeasure eachUom = eachUomMono.block();
        UnitOfMeasure tableSpoonUom = tableSpoonUomMono.block();
        UnitOfMeasure teapoonUom = teaSpoonUomMono.block();
        UnitOfMeasure dashUom = dashUomMono.block();
        UnitOfMeasure pintUom = pintUomMono.block();
        UnitOfMeasure cupsUom = cupsUomMono.block();
        //get Category Monos
        ...
        Mono<Category> mexicanCategoryMono = categoryReactiveRepository.findByDescription("Mexican")
        		.switchIfEmpty(Mono.error(new RuntimeException("Expected Category Not Found")));
        //get Categories
        Category americanCategory = americanCategoryMono.block();
        Category mexicanCategory = mexicanCategoryMono.block();
        //Yummy Guac
